...
\item
{\color{blue}$u_B(D,D) = -1$} \qquad {\color{red}$u_A(D,D) = -1$}
\item
{\color{blue}$u_B(D,C) = -9$} \qquad {\color{red}$u_A(D,C) = 0$}\\
{\color{blue}$u_B(C,D) = 0 $} \text{ } \qquad {\color{red}$u_A(C,D) = -9$}\\
{\color{blue}$u_B(C,C) = -6$} \qquad {\color{red}$u_A(C,C) = -6$}
\end{itemize}
\end{frame}
